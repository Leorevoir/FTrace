...
char *register_to_addr(pid_t pid, size_t reg);
char *register_to_void(pid_t pid, size_t reg);
char *register_to_pvoid(pid_t pid, size_t reg);

static const print_type_t print_table[128] = {
    {NUM, &register_to_signed},
    {STRING, &register_to_string},
    {UNSIGNED, &register_to_unsigned},
    {VOID_P, &register_to_pvoid},
    {CONST_VOID_P, &register_to_addr},
    {STRUCT_P, &register_to_addr},
    {STRUCT_STAT_P, &register_to_stat},
    {STRUCT_FD_P, &register_to_addr},
    {PVOID, &register_to_addr},
    {CONST_KERNEL_SIGSET_T_P, &register_to_addr},
    {KERNEL_SIGSET_T_P, &register_to_addr},
    {VARGS, &register_to_addr},
    {CONST_STRUCT_IOVEC_P, &register_to_addr},
    {FD_SET_P, &register_to_addr},
    {STRUCT_TIMEVAL_P, &register_to_addr},
    {VOID, &register_to_void},
    {STRUCT_SHMID_DS_P, &register_to_addr},
    {CONST_STRUCT_TIMESPEC_P, &register_to_addr},
    {STRUCT_TIMESPEC_P, &register_to_addr},
    {STRUCT_ITIMERVAL_P, &register_to_addr},
    {CONST_STRUCT_ITIMERVAL_P, &register_to_addr},
    {CONST_STRUCT_SOCKADDR_P, &register_to_addr},
    {SOCKLEN_T, &register_to_addr},
    {STRUCT_SOCKADDR_P, &register_to_addr},
    {SOCKLEN_T_P, &register_to_addr},
    {CONST_STRUCT_MSGHDR_P, &register_to_addr},
    {STRUCT_MSGHDR_P, &register_to_addr},
    {STRUCT_RUSAGE_P, &register_to_addr},
    {STRUCT_UTSNAME_P, &register_to_addr},
    {STRUCT_SEMBUF_P, &register_to_addr},
    {STRUCT_MSQID_DS_P, &register_to_addr},
    {STRUCT_LINUX_DIRENT_P, &register_to_addr},
    {MODE_T, &register_to_addr},
    {UID_T, &register_to_addr},
    {GID_T, &register_to_addr},
    {STRUCT_TIMEZONE_P, &register_to_addr},
    {STRUCT_RLIMIT_P, &register_to_addr},
    {CLOCK_T, &register_to_addr},
    {STRUCT_TMS_P, &register_to_addr},
    {ENUM_____REQUEST, &register_to_addr},
    {CONST_GID_T_P, &register_to_addr},
    {UID_T_P, &register_to_addr},
    {GID_T_P, &register_to_addr},
    {CAP_USER_HEADER_T, &register_to_addr},
    {CAP_USER_DATA_T, &register_to_addr},
    {CONST_CAP_USER_DATA_T, &register_to_addr},
    {CONST_STACK_T_P, &register_to_addr},
    {STACK_T_P, &register_to_addr},
    {CONST_STRUCT_UTIMBUF_P, &register_to_addr},
    {DEV_T, &register_to_addr},
    {STRUCT_STATFS_P, &register_to_addr},
    {ID_T, &register_to_addr},
    {CONST_STRUCT_SCHED_PARAM_P, &register_to_addr},
    {STRUCT_SCHED_PARAM_P, &register_to_addr},
    {STRUCT_TIMESPEC_P_, &register_to_addr},
    {STRUCT____ARGS_P, &register_to_addr},
    {STRUCT_TIMEX_P, &register_to_addr},
    {CONST_STRUCT_RLIMIT_P, &register_to_addr},
    {CONST_STRUCT_TIMEVAL_P, &register_to_addr},
    {CONST_STRUCT_TIMEZONE_P, &register_to_addr},
    {CADDR_T, &register_to_addr},
    {STRUCT_KERNEL_SYM_P, &register_to_addr},
    {NUM_P, &register_to_addr},
    {STRUCT_NFSCTL_ARG_P, &register_to_addr},
    {UNION_NFSCTL_RES_P, &register_to_addr},
    {OFF64_T, &register_to_signed},
    {TIME_T, &register_to_addr},
    {_T___T_P, &register_to_addr},
    {CONST_CPU_SET_T_P, &register_to_addr},
    {CPU_SET_T_P, &register_to_addr},
    {STRUCT_USER_DESC_P, &register_to_addr},
    {AIO_CONTEXT_T_P, &register_to_addr},
    {AIO_CONTEXT_T, &register_to_addr},
    {STRUCT_IO_EVENT_P, &register_to_addr},
    {STRUCT_IOCB_P, &register_to_addr},
    {U64, &register_to_addr},
    {STRUCT_LINUX_DIRENT64_P, &register_to_addr},
    {CLOCKID_T, &register_to_addr},
    {STRUCT_SIGEVENT_P, &register_to_addr},
    {TIMER_T_P, &register_to_addr},
    {TIMER_T, &register_to_addr},
    {CONST_STRUCT_ITIMERSPEC_P, &register_to_addr},
    {STRUCT_ITIMERSPEC_P, &register_to_addr},
    {STRUCT_EPOLL_EVENT_P, &register_to_addr},
    {CONST_STRUCT_TIMEVAL, &register_to_addr},
    {CONST_UNSIGNED_P, &register_to_addr},
    {UNSIGNED_P, &register_to_addr},
    {MQD_T, &register_to_addr},
    {CONST_STRUCT_SIGEVENT_P, &register_to_addr},
    {STRUCT_MQ_ATTR_P, &register_to_addr},
    {STRUCT_KEXEC_SEGMENT_P, &register_to_addr},
    {IDTYPE_T, &register_to_addr},
    {SIGINFO_T_P, &register_to_addr},
    {KEY_SERIAL_T, &register_to_addr},
    {UNUM32_T, &register_to_addr},
    {STRUCT_POLLFD_P, &register_to_addr},
    {CONST_SIGSET_T_P, &register_to_addr},
    {STRUCT_ROBUST_LIST_HEAD_P, &register_to_addr},
    {LNUM_P, &register_to_addr},
    {CONST_NUM_P, &register_to_addr},
    {CONST_STRUCT_TIMESPEC, &register_to_addr},
    {STRUCT_PERF_EVENT_ATTR_P, &register_to_addr},
    {STRUCT_MMSGHDR_P, &register_to_addr},
    {UNUM64_T, &register_to_addr},
    {STRUCT_FILE_HANDLE_P, &register_to_addr},
    {STRUCT__CACHE_P, &register_to_addr},
    {STRUCT_SCHED_ATTR_P, &register_to_addr},
    {UNION__ATTR_P, &register_to_addr},
    {0, NULL}
};
